...
1. Forschungsfrage:
- Ich erkenne das Instrument
- Der gleiche Ton ist in anderst in einem kleinen und einem grossen Raum
- Ein Daempfer bei der Trompete veraendert die Frequenz beim gleichen Ton
2. Forschungsfrage: 
...
# Pfad zum Audio-File
audio_file <- "pfad/zum/audiofile.mp3"

# Audio-File einlesen
audio <- readMP3(audio_file)

# Zeitvektor für das Audio-File erstellen
time <- (1:length(audio@left))/audio@samp.rate

# Amplituden des linken Audiokanals extrahieren
amplitudes <- audio@left

# Balkendiagramm erstellen
barplot(amplitudes, names.arg = time, xlab = "Zeit (s)", ylab = "Amplitude", col = "blue", main = "Amplitudenverlauf des Audio-Files")
