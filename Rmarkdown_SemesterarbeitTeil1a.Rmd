...
```
Diskussion: Die wav-Datei hat einen Kanal (links). Variablen:
Die Datei "1727_gekuerzt.wav" beinhaltet die gekuerte Datei.
...
## Beispielaufruf
# audio_file <- "1727.wav"  # Pfad Audiodatei
# print(audio_file)
#result <- analyze_audio(audio_file)
#print(data_no_na) #result
...
## Plotten der Druckwerte nach der Zeitachse
#timeArray <- (0:(61-1)) / audio@samp.rate  # Korrigierte Syntax
