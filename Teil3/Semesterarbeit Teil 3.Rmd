...
# Anzahl Personen pro Jahr aggregieren
...
# Einfacher plot der Values zeitdauer
...
# Annahme: Der Name des geladenen Objekts in der .RData-Datei ist "zeitdauerGesamtheit"
...
# Funktion sample() zur Entnahme von 100 Stichproben mit unterschiedlichem Umfang
...
# Ausgabe der ersten Probe zur Überprüfung
print(proben[[1]])
```
Aufgabe 3 b)
```{r}
...
# Funktion zur Entnahme von 100 Proben mit unterschiedlichem Stichprobenumfang
entnehme_proben <- function(data, num_proben = 100, sample_sizes = c(10, 50, 100, 500, 1000)) {
  set.seed(123)  # Seed für Reproduzierbarkeit
  probensammlung <- list()
...
# Funktion auf mehrere Elemente anwenden, Berechnet arithmetrisches Mittel jeder Probe
...
plot_qq_plots <- function(proben_list) {
  par(mfrow = c(2, 3))  # Layout für mehrere Plots
